...
<div class="card" id="rb-card" style="margin-top:28px;padding:26px">
  ...
  <p class="fine" style="color:var(--ash);margin-bottom:20px;max-width:64ch">This is everything a course creator can change on the participant report: two logos and the highlight colors. Nothing else moves. Changes apply to every report the moment you save.</p>
  ...
  <div class="row" style="gap:14px;margin-top:20px;align-items:center">
