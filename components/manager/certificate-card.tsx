...
export function CertificateCard({
  ...
  return (
    <article className="rounded-xl border-4 border-primary bg-white px-4 py-6 text-[#141210] sm:border-[6px] sm:px-10 sm:py-12">
      ...
      <p className="mt-4 text-center text-[#5c5648] italic">has completed</p>
      ...
      <dl className="mt-6 grid gap-4 text-sm sm:mt-8 sm:grid-cols-3 sm:gap-5">
        <div className="text-center sm:text-left">
          <dt className="text-[11px] tracking-[0.16em] text-[#5c5648] uppercase">Completed</dt>
          <dd className="mt-1 font-medium">{completedOn}</dd>
        </div>
        <div className="text-center">
          <dt className="text-[11px] tracking-[0.16em] text-[#5c5648] uppercase">Serial</dt>
          <dd className="mt-1 break-all font-mono text-xs">{serialNumber}</dd>
        </div>
        <div className="text-center sm:text-right">
          <dt className="text-[11px] tracking-[0.16em] text-[#5c5648] uppercase">Issued by</dt>
