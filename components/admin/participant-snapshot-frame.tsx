...
export function ParticipantSnapshotFrame({
  ...
  return (
    <div className="mx-auto w-full max-w-[26rem] rounded-[1.85rem] border border-border bg-header p-2 shadow-lg">
      <div className="overflow-hidden rounded-[1.45rem] border border-border bg-background">
        ...
        <nav
          ...
          className="flex h-14 border-t border-border bg-background/95"
        >
          <SnapshotTab
