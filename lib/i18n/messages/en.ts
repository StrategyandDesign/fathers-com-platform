export const en = {
  ...
  father: {
    ...
    assessments: {
      ...
      returnToAssessments: "Return to Assessments",
      introduction: "Introduction",
      purpose: "Purpose",
      goal: "Goal",
      youEarned: "You earned",
      youEarnedThis: "You earned this",
      designationOn: "This is your designation on {title}.",
      designationMeans: "What this designation means",
      designationScale: "Designations on this assessment",
  ...
  manager: {
    dashboard: {
      ...
      noteTitle: "Updates",
      noteLead:
        "Each leader can post one update. Fathers see them stacked on Home and can dismiss each one. A web address becomes a link they can open. Your new message replaces only your last update. The date and time become part of the message.",
      noteLeadMany:
        "Each group has its own updates. Each leader can post one. Fathers see them stacked on Home and can dismiss each one. A web address becomes a link they can open. Your new message replaces only your last update. The date and time become part of the message.",
      noteLabel: "Message",
      ...
      activityLead:
        "When a leader acts on this group, the others see it here. The record stays.",
      activityEmpty: "When a leader acts, it shows here for everyone on this desk.",
      activityYou: "You",
      activityUnknown: "did something on this desk",
      activityNotePosted: "posted an update",
      activityNoteCleared: "cleared an update",
      activityTrainingAssigned: "assigned a training",
      activityReviewAccepted: "accepted a training",
      activityReviewDeclined: "declined a training",
      activityCertificateIssued: "issued a certificate",
      activityParticipationSet: "set how men take assigned training",
      activityNudgeSent: "sent a note to a father",
      activityPhotoUpdated: "updated an organization photo",
      activityPhotoReset: "reset an organization photo",
      activityAssessmentAccepted: "accepted an assessment",
      activityAssessmentDeclined: "declined an assessment",
      activityAssessmentShared: "shared an assessment",
      activityAssessmentHidden: "hid an assessment",
      activityStaffAdded: "added {name} as a {role}",
      activityStaffRemoved: "removed {name}",
      staffEyebrow: "Leaders",
      staffTitle: "Who can lead this group",
      staffLead: "Every leader here has the same desk. What one does is recorded for the others.",
      staffEmpty: "You are the only leader on this group.",
      staffReviewers: "Reviewers: {names}",
      notePost: "Post update",
      noteReplace: "Swap your update",
      noteClear: "Clear your update",
  ...
  admin: {
    ...
    messages: {
      ...
      lead: "Send a short note to Leaders, Reviewers, or both. Fathers never see these.",
      compose: "Write a message",
      body: "Message",
      bodyPlaceholder: "What Leaders and Reviewers should see on their desk.",
      audience: "Who receives it",
      allLeaders: "All Leaders",
      selectedLeaders: "Selected Leaders",
      allReviewers: "All Reviewers",
      selectedReviewers: "Selected Reviewers",
      allStaff: "All Leaders and Reviewers",
      choosePeople: "Choose who receives it",
      noPeople: "No Leaders or Reviewers to send to yet.",
      send: "Send message",
      history: "Sent",
      emptyHistory: "No messages sent yet.",
      sent: "Message sent.",
      sentOne: "Sent to 1 person.",
      failed: "The message didn’t send. Try again.",
      bodyRequired: "Write a message first.",
      bodyTooLong: "Keep the message under 280 characters.",
      chooseAudience: "Choose who should receive this.",
      chooseRecipients: "Select at least one Leader or Reviewer.",
      tooMany: "Too many messages just now. Try again in a minute.",
      fathersNever: "Fathers do not receive these messages.",
      reached: "{n} received",
  ...
  staff: {
    ribbon: {
      eyebrow: "From Super-admin",
      dismiss: "Dismiss",
      dismissFailed: "Couldn’t dismiss that. Try again.",
    },
  },
  help: {
