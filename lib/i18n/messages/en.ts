export const en = {
  ...
  manager: {
    dashboard: {
      ...
      notePreviewEmpty: "Nothing is posted. Home stays as it is.",
      notePost: "Post note",
      noteReplace: "Replace note",
      noteClear: "Clear note",
      notePosted: "Note posted. Fathers will see it on Home.",
      noteCleared: "Note cleared.",
      noteRequired: "Write a short note before you post.",
      noteTooLong: "Keep the note under 280 characters.",
      noteChooseGroup: "Choose a group.",
      noteNotYours: "That group is not yours.",
      noteSaveFailed: "The note didn’t post. Try again.",
      noteClearFailed: "The note didn’t clear. Try again.",
    },
    nudgePanel: {
