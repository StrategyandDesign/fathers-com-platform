export const en = {
  ...
  flash: {
    ...
    profileProgressSaved: "Your Profile progress is saved. You can continue from the Profile tab.",
    profileSaveFailed: "Your Profile didn’t save. Try again.",
  ...
  father: {
    ...
    profile: {
      ...
      retakeLead:
        "You can start again if you want to see what’s changed. Your last results stay until a new Profile is completed.",
      continueRetake: "Continue the new Profile",
      retake: "Start a new Profile",
      progress: "Question {n} of {total} · {answered} answered",
      takeCta: "Start your Profile",
      takeHint:
      ...
      noResultsBody: "Finish the Profile and you will get two names: a stance to keep, and a strength to use.",
      ...
      resultsComplete: "Profile complete",
      resultsLead:
  ...
  manager: {
    ...
    participants: {
      ...
      fatherProfile: "Keystone Profile",
      fatherProfileLead: "The 128-question Keystone Profile. Primary Determination and Primary Edge when he finishes.",
