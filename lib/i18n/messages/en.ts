export const en = {
  ...
  notify: {
    ...
    sessionRemindersHint: "When your next session is open and not started.",
    ...
    weeklyWhen: "Weekly reminder time",
    day: "Day",
  ...
  father: {
    ...
    start: {
      ...
      reminderBody: "One reminder a week. You can change it any time.",
      reminderTime: "Time",
