export const en = {
  ...
  father: {
    home: {
      ...
      continueProfile: "Continue this part",
      takeProfile: "Start this part",
      ...
      profileReminder: "One part. You can stop and come back.",
      takeProfileTitle: "Keystone",
      takeProfileBody: "A primary determination and one next step.",
    ...
    profile: {
      title: "Keystone",
      lead: "A primary determination and one next step.",
      leadComplete: "Your last results. Open the card for what the names mean.",
      keystone: "Keystone",
      ...
      retakeLead: "Last results stay until a new Assessment is completed.",
      continueRetake: "Continue the new Assessment",
      continuePart: "Continue this part",
      retake: "Start again",
      progress: "Part {n} of {total}. You can stop and come back.",
      takeCta: "Start this part",
      takeHint: "One part. You can stop and come back.",
      howToAnswer:
      ...
      noResultsBody: "Finish Keystone and you will get two names: a stance to keep, and a strength to use.",
      seeResults: "Finish",
      chooseThenConfirm: "Choose an answer. That opens your results.",
      ...
      backToProfile: "Back to Assessments",
      resultsComplete: "Keystone. {date}",
      resultsIn: "It’s in.",
      resultsLead: "A stance to keep, and a strength to use.",
      fitsTraining: "A training that fits this: {title}.",
      fitsTrainingLead: "A training that fits this:",
      keepCopy: "Keep a copy",
      lastTime: "Last time: {date}",
      partClose: "Part {n} is in. {left} left.",
      partCloseLeft1: "One",
      partCloseLeft2: "Two",
      partCloseLeft3: "Three",
      nextPart: "Do the next part",
  ...
  manager: {
    ...
    participants: {
      ...
      fatherProfileLead: "Keystone. You see that he finished, and the determination. Not his answers.",
    ...
    assessments: {
      ...
      keystoneLead:
        "The Keystone Assessment. A Super-admin shares it with you. You decide when fathers in the group can take it.",
