export const fieldClassName =
  "h-11 w-full min-w-0 max-w-full rounded-lg border border-input bg-input-fill px-3 text-base text-foreground outline-none transition-[border-color,box-shadow] duration-150 ease-out placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/35 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 md:text-sm";

export const authFieldClassName =
  `${fieldClassName} border-primary/40`;

export const textareaClassName =
  "min-h-28 w-full rounded-lg border border-input bg-input-fill px-3 py-3 text-base text-foreground outline-none transition-[border-color,box-shadow] duration-150 ease-out placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/35 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 md:min-h-24 md:py-2.5 md:text-sm";
...
export const interactiveSurfaceClassName =
  `${interactiveControlClassName} hover:bg-hover focus-visible:bg-hover`;
...
export const interactiveIconClassName =
  `${interactiveControlClassName} hover:bg-hover`;

export const headerIconClassName =
  `${interactiveControlClassName} text-header-foreground hover:bg-header-hover`;

export const radioOptionClassName =
  `flex min-h-11 cursor-pointer items-center gap-3 rounded-lg border border-border px-3 py-3 text-base ${interactiveControlClassName} hover:bg-hover has-[:checked]:border-primary/50 has-[:checked]:bg-hover focus-within:border-ring focus-within:ring-3 focus-within:ring-ring/50`;

export const checkboxOptionClassName =
  `flex min-h-11 cursor-pointer items-center gap-3 rounded-lg text-sm ${interactiveControlClassName} hover:bg-hover focus-within:ring-3 focus-within:ring-ring/50`;
